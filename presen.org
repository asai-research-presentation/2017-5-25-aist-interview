...
** Xerox PARC Printer: */Hypermoduler/* System
...
AlphaGo [Sievers 16], ルービックキューブ [Arfaee et al., 2011], 8パズル他 [Satzger and Kramer, 2013]
 ...
 *カーナビ、ソーシャルグラフなど* : Explicit Graph Search
 ...
 参考: 2012年の全世界のデジタルデータ: 数ZB (1ZB = 10^21 B)
 ...
 *JAIR*, *AIJ* : 論文誌でもプランニングは多い (JAIR Volume 54: 12本中 2本 がプランニング論文)
...
+ SATソルバ, ASP(解集合)ソルバ, CPソルバ系, 推論系 -- logic and reasoning ::
  + 田中 哲朗先生 (総合文化研究科), 鍋島英知先生 (山梨大)
  + 井上克己先生 (NII) --- Lemma Reusing for SAT based Planning and Scheduling (ICAPS10)
  + 田村直之先生, 平山勝利先生 (神戸大), 田沼秀樹先生 (東工大)
+ AAMAS マルチエージェント, CSP :: 九大 横尾誠先生
+ ERATO: 同じくグラフ探索だが、explicit graph :: 河原林健一先生 (NII), 秋葉先生
+ ゲーム系 :: 岸本先生 (東工大→IBM Research), 金子先生 (ゲーム, 総合文化)
